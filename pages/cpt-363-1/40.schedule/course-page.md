...
## [[svg-icon icon="calendar-week" set="tabler" /]Week 1 (May 9 - 15)](../modules/module-01)
**What is usability and user experience design?**  
[svg-icon icon="device-desktop" set="tabler" /][Introduction to UX Design](https://www.google.ca/slides/about/)   
[svg-icon icon="book" set="tabler" /][Usability 101: Introduction to Usability](https://www.nngroup.com/articles/usability-101-introduction-to-usability/)  
...
## [[svg-icon icon="calendar-week" set="tabler" /]Week 4 (May 30 - Jun 5)](../modules/module-04)
**How to explore and communicate possible design solutions?**   
[svg-icon icon="device-desktop" set="tabler" /][Prototyping](https://www.google.ca/slides/about/)   
[svg-icon icon="book" set="tabler" /][The Skeptic's Guide To Low-Fidelity Prototyping](https://www.smashingmagazine.com/2014/10/the-skeptics-guide-to-low-fidelity-prototyping/)  
[svg-icon icon="users" set="tabler" /]In-class office hours (tentative)  

## [[svg-icon icon="calendar-week" set="tabler" /]Week 5 (Jun 6 - 12)](../modules/module-05)
**How to plan, conduct, and summarize usability tests?**  
[svg-icon icon="device-desktop" set="tabler" /][Usability Testing](https://www.google.ca/slides/about/)   
[svg-icon icon="book" set="tabler" /][A Guide to the Art of Guerrilla UX Testing](https://medium.springboard.com/a-guide-to-the-art-of-guerrilla-ux-testing-69a1411d34fb)  
[svg-icon icon="users" set="tabler" /]In-class office hours (tentative)
...
## [svg-icon icon="calendar-week" set="tabler" /]Week 7 (Jun 20 - 26)
**How to design for mobile and multi-device usage?**  
[svg-icon icon="device-desktop" set="tabler" /][Mobile and Multi-device Design](https://www.google.ca/slides/about/)   
[svg-icon icon="book" set="tabler" /][Mobile first - Insights from going mobile only](http://blog.invisionapp.com/mobile-first-mobile-only/)  
...
## [svg-icon icon="calendar-week" set="tabler" /]Week 9 (Jul 4 - 10)
**Instructor User Research Plan Meetings**  
TBD  

## [svg-icon icon="calendar-week" set="tabler" /]Week 10 (Jul 11 - 17)
**How to design products for how people think, learn and feel?**  
[svg-icon icon="device-desktop" set="tabler" /][Interaction Design](https://www.google.ca/slides/about/)  
[svg-icon icon="book" set="tabler" /][A Lean UX Iteration on Dropbox Photos](https://medium.com/bridge-collection/a-lean-ux-iteration-on-dropbox-photos-edfa7b245c27#.fdtsczbnj)
...
## [svg-icon icon="calendar-week" set="tabler" /]Week 12 (Jul 25 - 31)
**Instructor Design Critique Meetings**  
TBD  
[svg-icon icon="book" set="tabler" /][How to Give and Receive Criticism](http://scottberkun.com/essays/35-how-to-give-and-receive-criticism/)

## [svg-icon icon="calendar-week" set="tabler" /]Week 13 (Aug 1)
**Course Wrap-up**  
Guest Speaker